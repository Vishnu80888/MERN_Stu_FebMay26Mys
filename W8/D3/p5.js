...
async function main() {
    try {
        ...
        const course3 = await Course.create({title:"Express JS"});
        ...
        const student2 = await Student.create({
            name:"Darshan",
            courses:[course2._id,course3._id]
        });
        ...
        course2.students.push(student2._id,student3._id);
        course3.students.push(student1._id);
